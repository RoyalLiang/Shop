...
(function(mod) {
  ...
  function Display(place, doc, input) {
    ...
    // Information other the rendered lines.
    d.view = [];
    d.renderedView = null;
    // Holds info other a single rendered line when it was rendered
  ...
  // information other line-wide styles that were set by the mode.
